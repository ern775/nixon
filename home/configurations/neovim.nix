...
}:
{
  ...
  programs.neovim = {
    ...
    extraPackages = with pkgs; [
      # LazyVim-specific deps. ripgrep/fd/gnumake/gcc/unzip/tree-sitter
      ripgrep
      fd
      gnumake
      gcc
  ...
  # both entries to launch alacritty explicitly, matching the yazi/btop pattern in
